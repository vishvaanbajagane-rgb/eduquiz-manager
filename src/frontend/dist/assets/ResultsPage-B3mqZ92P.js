import { c as createLucideIcon, u as useNavigate, r as reactExports, j as jsxRuntimeExports, L as LoadingSpinner, B as Button } from "./index-bpXuEzrw.js";
import { u as useActor, a as useQuery, c as createActor } from "./backend-CCEFFmVU.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-CmR3d6zk.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, I as Input, C as ChevronDown } from "./select-lvEbVpzU.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-Ch6eeKAK.js";
import { u as useAuth } from "./useAuth-C9wYs-_s.js";
import { u as useRole } from "./useRole-BpWvTBpD.js";
import { a as ChartColumn, A as AdminLayout } from "./AdminLayout-CtcNoo36.js";
import { U as Users } from "./users-BPiCCJSO.js";
import { T as Trophy } from "./index-Cxvel48n.js";
import { C as ChevronRight, a as CircleX } from "./circle-x-DmdCcW9h.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      TableRow,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: studentName }) }),
...
function ResultsPage() {
  ...
  const nameMap = reactExports.useMemo(
    () => new Map(
  ...
  const filteredAttempts = reactExports.useMemo(() => {
    ...
    if (q)
      list = list.filter((a) => {
        ...
        const name = (nameMap.get(a.studentPrincipal.toString()) ?? "").toLowerCase();
